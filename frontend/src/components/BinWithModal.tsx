function BinWithModal({ id, className }: { id: string; className: string }) {
  return (
    <svg
      fill="#000000"
      version="1.1"
      ...
      className={`fill-base-content hover:fill-error cursor-pointer ${className}`}
    >
      <g>
        <g>
          <path
